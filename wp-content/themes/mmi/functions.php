...
class StarterSite extends Timber\Site {
    ...
    public function register_assets(){
        ...
        // 'id unique', chemin/url
        wp_enqueue_script('SFUIDisplay-Light', get_template_directory_uri() . '/assets/fonts/sf-ui-display-light.woff', array(), 1.0 );
        wp_enqueue_script('SFUIDisplay-Medium', get_template_directory_uri() . '/assets/fonts/sf-ui-display-medium.woff', array(), 1.0 );
        wp_enqueue_script('SFUIDisplay-Bold', get_template_directory_uri() . '/assets/fonts/sf-ui-display-bold.woff', array(), 1.0 );
    }
